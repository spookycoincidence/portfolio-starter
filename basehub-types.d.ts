...
export interface Scalars {
  ...
  private: boolean
    ...
    JSON: any,
    String: string,
    bshb_event_317471939: `bshb_event_317471939:${string}`,
    schema_bshb_event_317471939: {message?: string;name?: string;email: string;},
    bshb_workflow_132341158: `bshb_workflow_132341158:${string}`,
...
export type BlockDocument = (ContactForm | _AgentStart) & { __isUnion?: true }
...
export interface ContactForm {
    ...
    _title: Scalars['String']
    form: Form
    newSubmitNotification: NewSubmitNotification
...
export interface NewSubmitNotification {
    /** The `webhookSecret` is used to verify the authenticity of the webhook request, and also to type the payload. */
    webhookSecret: Scalars['bshb_workflow_132341158']
    __typename: 'NewSubmitNotification'
}
...
export interface BlockDocumentGenqlSelection{
    ...
    on_ContactForm?: ContactFormGenqlSelection
...
export interface ContactFormGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    newSubmitNotification?: NewSubmitNotificationGenqlSelection
    __typename?: boolean | number
}
...
export interface NewSubmitNotificationGenqlSelection{
    /** The `webhookSecret` is used to verify the authenticity of the webhook request, and also to type the payload. */
...
export interface QueryGenqlSelection{
    ...
    contactForm?: ContactFormGenqlSelection
    __typename?: boolean | number
}
...
export interface FragmentsMap {
  ...
  ContactForm: {
    root: ContactForm,
    selection: ContactFormGenqlSelection,
}
  Form: {
    root: Form,
  ...
  NewSubmitNotification: {
    root: NewSubmitNotification,
    selection: NewSubmitNotificationGenqlSelection,
}
  Query: {
    root: Query,
