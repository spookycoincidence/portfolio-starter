...
export function ContactCard() {
  ...
  return (
    <>
      {/* Mobile */}
      <div className="md:hidden text-left px-4 py-10 text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <label className="flex flex-col gap-y-1">
            ...
            <input
              ...
              className="w-full border border-gray-700 bg-gray-900 text-white rounded p-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-violet-400 text-sm"
            />
          </label>
          ...
          <button
            type="submit"
            className="bg-gray-800 border border-gray-700 text-white py-2 px-4 rounded shadow hover:bg-gray-700 transition w-full text-sm"
          >
            Send
          </button>
        </form>
